...
/* com_angle:(cur_t,state[666],com_angle0[3],com_angleT[3])->(com_ang[3]) */
...
void mex_com_angle(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  --resc;
  res[0] = w+673;
  i = com_angle(arg, res, iw, w+676, 0);
