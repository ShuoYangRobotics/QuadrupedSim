...
stance_tgt    = [0.2; 0; quad_param.leg_l2; ...       % pos x y z, 
                    0; 0; 0; ...                       % orientation roll, pitch, yaw
                    0; 0; 90/180*pi;...                % leg1 angles
                    0; 0; 90/180*pi;...                % leg2 angles
                    0; 0; 90/180*pi;...                % leg3 angles
...
%% optimal
% for this testing problem, do simple scaling here
stance_origin(19:30) = stance_origin(19:30)/100;
stance_tgt(19:30) = stance_tgt(19:30)/100;
...
%%
save('quad_opt_output', 'opt_state_init', 'opt_state_soln');
%% visualize
%% visualize solution
