...
for i = 1:param.leg_num
    ...
    averge_pos = averge_pos1;
    for j = 1:param.sw_knot_num
        knot_idx = sp.getLegSwingKnot(idx_state, i, j, 0);
        Pvel = param.max_foot_pos_vel;
        swing_lb = averge_pos - param.swing_bound;
        swing_ub = averge_pos + param.swing_bound;
...
for i = 1:param.leg_num 
    for j = 1:2*param.st_knot_num
        ...
        F1 = param.terrain_u2*param.weight_ratio*param.total_mass*param.g/param.force_scale;
        F2 = param.terrain_u2*param.weight_ratio*param.total_mass*param.g/param.force_scale;
        F3 = param.weight_ratio*param.total_mass*param.g/param.force_scale;
